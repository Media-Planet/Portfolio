        ...
        >
          <div className={`col-md-6 ${styles.textContainer} `}>
            ...
            <div className={`${styles.cardCustom}`}>
              <h1
                className={`${styles.cardH1Font} ${styles.glitch} ${
                  styles.title_1
                } ${i18n.language === "ar" ? "pe-2" : ""}`}
              >
                {t("Media Planet")}
              </h1>
              <div className={`${styles.textBox} `}>
                <p className={` ${styles.paragraph}`}>
                  {t(
                    "Where bold ideas collide with storytelling, tech, and design to create immersive campaigns crafted to stand out, speak loud, and leave a mark."
                  )}
                </p>
                <img
                  src="src\assets\image\halfMoon.png"
                  className={`${styles.halfMoon} ${
                    i18n.language === "ar" ? styles["mirror-y"] : ""
                  }`}
                  alt="half moon"
                />
              </div>
              <div className=" mt-4">
                ...
                <a
                  href="#"
                  className={`mt-4 ${styles.btnGallery} ${
                    i18n.language === "ar"
                      ? styles["btn_2"]
                      : styles["btnCustom"]
                  }`}
