      ...
      <div className="px-3 px-sm-4 bg-primary" dir={Direction || "ltr"}>
          ...
          <div className="row">
            ...
            <section className="col-sm-6">
              ...
              <p className={`InterF text-black ${style["Sec2_P_S_2"]}`}>
                {t(
                  "From casual to competitive, adults to kids - our games captivate players of all types."
                )}
              </p>
            </section>
          </div>
        ...
        <div className="mt-sm-5">
          <section className="row">
            <div className="col-7">
              <h2
                className={`Times_New_RomanF_italic text-black mt-2 mb-5 ${style["H_S4"]}`}
              >
                {t("Why Choose Us?")}
              </h2>
              <p className={`InterF text-black my-5 ${style["P_S4"]}`}>
                {t(
