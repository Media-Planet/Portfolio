  ...
  return (
    <>
      <div className="px-3 px-sm-4 bg-primary" dir={Direction || "ltr"}>
          ...
          <div className="row">
            ...
            <section className="col-sm-6">
              ...
              <p className={`InterF text-black ${style["Sec2_P_S_2"]}`}>
                From organic search to paid ads, social media content - we get
                results through diverse digital channels.
              </p>
        ...
        <div>
          <h2
            className={`Times_New_RomanF_italic text-black mb-4 mt-2 mt-sm-2 mb-sm-5 ${style["H_S3"]}`}
          >
            Our Approach
          </h2>
          ...
          <section className="row gap-5 justify-content-around">
            <div className="col-3 d-flex justify-content-center flex-column">
              ...
              <p
                className={`${style["Sec3_P_S"]} InterF text-black text-center`}
              >
                Understand your business and campaign goals.
              </p>
            </div>
            ...
            <div className="col-3 d-flex justify-content-center flex-column text-center">
              ...
              <p className={`${style["Sec3_P_S"]} InterF text-black`}>
                Analyze data and optimize campaign.
              </p>
            </div>
          </section>
        ...
        <div className="mt-sm-5">
          <section className="row">
            <div className="col-7">
              <h2
                className={`Times_New_RomanF_italic text-black mt-2 mb-5 ${style["H_S"]}`}
              >
                Why Choose Us?
              </h2>
              <p className={`InterF text-black my-5 ${style["P_S"]}`}>
                We’re not just marketers – we are digital growth strategists. We
                plan and execute data-driven campaigns that deliver measurable
                results and build lasting brand engagement across every
                platform.
              </p>
            </div>
