                    ...
                    <div className='row'>
                        ...
                        <section className='col-sm-6'>
                            {window.innerWidth < 576 ?
                                (<>
                                    <h3 className={`Times_New_RomanF_italic text-black mt-5 mb-3 ${style['Sec2_DM_H_S_2']}`}>Results across channels</h3>
                                    <img src={imgs.sec2_png1} alt="#" className={`${style['img_S']}`} />
                                    <p className={`text-center InterF text-black ${style['Sec2_P_S_2']}`}>From organic search to paid ads,
                        ...
                        (<>
                            <section className='row justify-content-around'>
                                <div className='col-9 d-flex justify-content-center flex-column text-center'>
                                    ...
                                    <p className={`${style['Sec3_P_S']} InterF text-black my-3`}>Understand your business and campaign goals.</p>
                                    <div className='d-flex'>
                                        <p className='border border-black w-100'></p>
                                    </div>
                                </div>
                                <div className='col-9 d-flex justify-content-center flex-column text-center'>
                                    <img src={imgs.sec3_P2} />
                                    <p className={`${style['Sec3_P_S']} InterF text-black my-3`}>Produce high quality and engaging content for each platform.</p>
                                    <div className='d-flex'>
                                        <p className='border border-black w-100'></p>
                                    </div>
                                </div>
                                <div className='col-9 d-flex justify-content-center flex-column text-center'>
                                    ...
                                    <p className={`${style['Sec3_P_S']} InterF text-black my-3`}>Analyze data and optimize campaign.</p>
                                    <div className='d-flex'>
                                        <p className='border border-black w-100'></p>
                                    </div>
                                </div>
                        ...
                        (<>
                            <section className='row'>
                                <div className='col-12'>
                                    ...
                                    <p className={`InterF text-black mb-2 my-sm-5 ${style['P_S4']}`}>We’re not just marketers – we are digital growth strategists.
                                ...
                                <div className='col-12'>
                                    <li className='list-unstyled d-flex flex-column gap-sm-4'>
                                        <ul className={`${style['Sec4_Ul_S']} InterF text-black align-content-center p-0 mt-3 mt-sm-0`}>
                                            <img src={imgs.sec3_S4} className={`${style['Sec4_S_img_S']} mx-2`} alt="..." />Analytical & Data-Driven
                                        </ul>
                                        <ul className={`${style['Sec4_Ul_S']} InterF text-black align-content-center p-0`}>
                                            <img src={imgs.sec3_S5} className={`${style['Sec4_S_img_S']} mx-2`} alt="..." />Multi-Platform Strategy
                                        </ul>
                                        <ul className={`${style['Sec4_Ul_S']} InterF text-black align-content-center p-0`}>
                                            <img src={imgs.sec3_S6} className={`${style['Sec4_S_img_S']} mx-2`} alt="..." />Optimized & Scalable Campaigns
                                        </ul>
                                    </li>
                                </div>
                            </section>
