  ...
  return (
    <>
      <div className='px-3 px-sm-4 bg-primary' dir={Direction || 'ltr'}>
        <h2 className={`Times_New_RomanF_italic text-black pt-2 ${style['H_S']}`}>{t("Digital Marketing")}</h2>
        <div className='row justify-content-between'>
          <section className='d-grid col-8 col-sm-7 pe-0'>
            <p className={`align-self-center InterF text-black mb-0 ${style['P_S']} pe-0`}>{t("We create eye-catching content and smart campaigns that grow your brand, spark engagement, and drive results.")}</p>
          ...
          <section className='col p-0'>
            <img src={(i18n.language === 'ar') ? photo_AR : imgs.photo} className={`${style['img_S']}`} alt="... coding" />
          </section>
        </div>
          ...
          <div className='row'>
            <section className='col-sm-6'>
              ...
              <p className={`InterF text-black mb-4 mb-sm-5 ${style['Sec2_P_S_2']}`}>
                {t("From strategy to launch, we design effective campaigns that bring your story to life -cross-platform, impactful, and built to endure.")}
              </p>
            ...
            <section className='col-sm-6'>
              ...
              <h3 className={`Times_New_RomanF_italic text-black ${style['Sec2_H_S_2']}`}>{t("Results across channels")}</h3>
            ...
            <div className='col-5 align-content-center'>
              <li className='list-unstyled d-flex flex-column gap-4'>
                <ul className={`${style['Sec3_Ul_S']} InterF text-black align-content-center`}>
                  <img src={imgs.sec3_S4} className={`${style['Sec3_S_img_S']} mx-2`} alt="..." />{t("Analytical & Data-Driven")}
                </ul>
                <ul className={`${style['Sec3_Ul_S']} InterF text-black align-content-center`}>
                  <img src={imgs.sec3_S5} className={`${style['Sec3_S_img_S']} mx-2`} alt="..." />{t("Multi-Platform Strategy")}
                </ul>
                <ul className={`${style['Sec3_Ul_S']} InterF text-black align-content-center`}>
                  <img src={imgs.sec3_S6} className={`${style['Sec3_S_img_S']} mx-2`} alt="..." />{t("Optimized & Scalable Campaigns")}
                </ul>
              </li>
            </div>
          </section>
