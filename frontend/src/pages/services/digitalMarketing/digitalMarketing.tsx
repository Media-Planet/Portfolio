                ...
                <section className={`${style['sec_S']} pt-3`}>
                    <div className='row'>
                        <section className='row col-7'>
                            <h2 className={`Times_New_RomanF_italic text-black mt-3 mb-5 ${style['H_S']}`}>Digital Marketing</h2>
                            <p className={`InterF text-black my-5 ${style['P_S']}`}>We create eye-catching content
