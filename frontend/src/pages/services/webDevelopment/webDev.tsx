                    ...
                    <div className='row'>
                        ...
                        <section className='col-sm-6'>
                            {window.innerWidth < 576 ?
                                (<>
                                    <h3 className={`Times_New_RomanF_italic text-black mt-5 mb-0  ${style['Sec2_H_S_2']}`}>Built for every screen</h3>
                                    <img src={imgs.sec2_png1} alt="#" className={`${style['img_S']}`} />
                                    <p className={`text-center InterF text-black ${style['Sec2_P_S_2']}`}>Your website will shine everywhere from big screens to mobile
                    ...
                    {window.innerWidth < 576 ?
                        (<>
                            <section className='row justify-content-around'>
                                <div className='col-7 d-flex justify-content-center flex-column text-center'>
                                    <img src={imgs.sec3_P1} />
                                    <p className={`${style['Sec3_P_S']} InterF text-black my-3`}>Understand goals and user needs</p>
                                ...
                                <div className='col-7 d-flex justify-content-center flex-column text-center'>
                                    ...
                                    <p className={`${style['Sec3_P_S']} InterF text-black my-3`}>Create beautiful, functional layouts</p>
                                    <div className='d-flex'>
                                        <p className='mx-2 border border-black w-100'></p>
                                    </div>
                                </div>
                                <div className='col-7 d-flex justify-content-center flex-column text-center'>
                                    ...
                                    <p className={`${style['Sec3_P_S']} InterF text-black my-3`}>Develop and launch with precision</p>
                                    <div className='d-flex'>
                                        <p className='mx-2 border border-black w-100'></p>
                                    </div>
                                </div>
                        ...
                        (<>
                            <section className='row gap-5 justify-content-around'>
                                <div className='col-3 d-flex justify-content-center flex-column text-center'>
                                    <img src={imgs.sec3_P1} />
                                    <p className={`${style['Sec3_P_S']} InterF text-black`}>Understand goals and user needs</p>
                                </div>
                                <div className='col-3 d-flex justify-content-center flex-column text-center'>
                                    <img src={imgs.sec3_P2} />
                                ...
                                <div className='col-12'>
                                    <li className='list-unstyled d-flex flex-column gap-sm-4'>
                                        ...
                                        <ul className={`${style['Sec4_Ul_S']} InterF text-black align-content-center p-0`}>
                                            <img src={imgs.sec3_S6} className={`${style['Sec4_S_img_S']} mx-2`} alt="..." />Accessible & User-Friendly
                                        </ul>
                                        <ul className={`${style['Sec4_Ul_S']} InterF text-black align-content-center p-0`}>
                                            <img src={imgs.sec3_S7} className={`${style['Sec4_S_img_S']} mx-2`} alt="..." />Built for Growth
                                        </ul>
                                    </li>
                                </div>
                            </section>
