          ...
          <div className="row">
            ...
            <section className="col-sm-6">
              {window.innerWidth < 576 ? (
                <>
                  <h3
                    className={`Times_New_RomanF_italic text-black mt-5 mb-0  ${style["Sec2_H_S_2"]}`}
                  >
                  ...
                  />
                  <p
                    className={`text-center InterF text-black ${style["Sec2_P_S_2"]}`}
                  >
            ...
            <>
              <section className="row justify-content-around">
                <div className="col-7 d-flex justify-content-center flex-column text-center">
                  ...
                  <p className={`${style["Sec3_P_S"]} InterF text-black my-3`}>
            ...
            <>
              <section className="row">
                <div className="col-12">
                  ...
                  <p
                    className={`InterF text-black mb-2 my-sm-5 ${style["P_S4"]}`}
                  >
                ...
                <div className="col-12">
                  <li className="list-unstyled d-flex flex-column gap-sm-4">
                    <ul
                      className={`${style["Sec4_Ul_S"]} InterF text-black align-content-center p-0 mt-3 mt-sm-0`}
                    >
                      <img
                        src={imgs.sec3_S5}
                        className={`${style["Sec4_S_img_S"]} mx-2`}
                        alt="..."
                      />
                      Fast Load Times
                    </ul>
                    <ul
                      className={`${style["Sec4_Ul_S"]} InterF text-black align-content-center p-0`}
                    >
                      <img
                        src={imgs.sec3_S6}
                        className={`${style["Sec4_S_img_S"]} mx-2`}
